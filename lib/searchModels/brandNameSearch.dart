...
class SearchDrugBrandName extends SearchDelegate {
  final FetchDrugbrandName _drugList_brandName = FetchDrugbrandName();
  ...
  Widget buildResults(BuildContext context) =>
      FutureBuilder<List<DrugListBrandName>>(
          future: _drugList_brandName.getDrugListbrandName(query),
  ...
  // );
  {
    final suggestions = query.isEmpty
        ...
        : drugstosearch_brandName.where((drugtosearchBrandname) {
