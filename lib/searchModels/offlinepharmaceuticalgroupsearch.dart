...
class DictionaryDBPharGroupSearch extends SearchDelegate {
  final LocalDatabase latestnewpharmaceuticalgroupdrug = LocalDatabase();
  ...
  Widget buildResults(BuildContext context) =>
      Container(
        ...
        child: FutureBuilder<List<Map<String,dynamic>>>(
            future: LocalDatabase.searchAllPharmGroupDrugsDB(query),
            builder: (context, snapshot) {
              ...
              // else if (snapshot.hasData) {}
                ...
                return
                  AlertDialog.adaptive(scrollable: true,
