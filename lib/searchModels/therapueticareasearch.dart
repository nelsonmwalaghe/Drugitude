...
class SearchDrugTherapueticArea extends SearchDelegate {
  ...
  Widget buildResults(BuildContext context) =>
      FutureBuilder<List<DrugListTherapueticArea>>(
                                    ...
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Padding(
                                          ...
                                          child: Text('Category: ${dataTherapueticArea?[index].category.name}',style: const TextStyle(color: Colors.white54, fontSize: 12),),
                                        ),
                                        Padding(
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                          child: Text('${dataTherapueticArea?[index].authorisationStatus.name}',
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                          child: Text('Product Number: ${dataTherapueticArea?[index].productNumber}; ATC-Code: ${dataTherapueticArea?[index].atccode}, Generic? ${dataTherapueticArea?[index].generic.name}, Biosimilar? ${dataTherapueticArea?[index].biosimilar.name}, Conditional Approval: ${dataTherapueticArea?[index].conditionalApproval.name}, Exceptional Circumstances: ${dataTherapueticArea?[index].exceptionalCircumstances.name}, Accelerated Assessment: ${dataTherapueticArea?[index].acceleratedAssessment.name}, Orphan Medicine: ${dataTherapueticArea?[index].orphanMedicine.name}, Marketing Authorization Date: ${dataTherapueticArea?[index].marketingAuthorisationDate}, Date of Opinion: ${dataTherapueticArea?[index].dateofOpinion}, Decision Date: ${dataTherapueticArea?[index].decisionDate}, First Published: ${dataTherapueticArea?[index].firstPublished}, Revision Date: ${dataTherapueticArea?[index].revisionDate}, Revision Number: ${dataTherapueticArea?[index].revisionNumber}, url: ${dataTherapueticArea?[index].url}',
                                              overflow: TextOverflow.fade,
                                              textAlign: TextAlign.start,
                                              style: const TextStyle(fontSize: 12,
                                                  color: Colors.white70,
