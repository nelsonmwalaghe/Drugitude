...
import 'package:drugitudeleviosa/api_service_models/day_drug_api_model.dart';
...
class DayDrugSearch extends SearchDelegate {
                      ...
                      title: Row(
                        children: [
                          Container(
                            ...
                            child: Center(
                              child: Text(
                                '${data_daydrug?[index].medicineName}',
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                                  Text('${data_daydrug?[index].innName}',
                                      style: const TextStyle(color: Colors.black)),
                                ],
                              ),
                            ],
