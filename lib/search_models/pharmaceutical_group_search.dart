...
class SearchDrug_PhramGroup extends SearchDelegate {
  final FetchDrug_phramGroup _drugList_phramGroup = FetchDrug_phramGroup();
  final drugstosearch_phramGroup = [
                                ...
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Padding(
                                      ...
                                      child: Text('Category: ${data_phramGroup?[index].category.name}',style: TextStyle(color: Colors.white54, fontSize: 12),),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                      child: Text('${data_phramGroup?[index].medicineName}',
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                      child: Text('${data_phramGroup?[index].innName}',
                                        textAlign: TextAlign.start,
                                        style: TextStyle(
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                      child: Text('Active Substance: ${data_phramGroup?[index].activeSubstance}',
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                      child: Text('${data_phramGroup?[index].therapeuticArea}',
                                        textAlign: TextAlign.start,
                                        style: TextStyle(
                                            color: Colors.white,
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                      child: Text('${data_phramGroup?[index].humanPharmacotherapeuticGroup}',
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                      child: Text('${data_phramGroup?[index].marketingAuthorisationHolderorCompanyName}',
                                          style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)
                                      ),
                                    ),
                                    Padding(
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                      child: Text('${data_phramGroup?[index].authorisationStatus.name}',
                                    ...
                                    Padding(
                                      ...
                                      child: Text('${data_phramGroup?[index].conditionOrIndication}',
                                        overflow: TextOverflow.fade,
                                        textAlign: TextAlign.start,
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                      child: Text('Product Number: ${data_phramGroup?[index].productNumber}; ATC-Code: ${data_phramGroup?[index].atccode}, Generic? ${data_phramGroup?[index].generic.name}, Biosimilar? ${data_phramGroup?[index].biosimilar.name}, Conditional Approval: ${data_phramGroup?[index].conditionalApproval.name}, Exceptional Circumstances: ${data_phramGroup?[index].exceptionalCircumstances.name}, Accelerated Assessment: ${data_phramGroup?[index].acceleratedAssessment.name}, Orphan Medicine: ${data_phramGroup?[index].orphanMedicine.name}, Marketing Authorization Date: ${data_phramGroup?[index].marketingAuthorisationDate}, Date of Opinion: ${data_phramGroup?[index].dateofOpinion}, Decision Date: ${data_phramGroup?[index].decisionDate}, First Published: ${data_phramGroup?[index].firstPublished}, Revision Date: ${data_phramGroup?[index].revisionDate}, Revision Number: ${data_phramGroup?[index].revisionNumber}, url: ${data_phramGroup?[index].url.toString()}',
                                          overflow: TextOverflow.fade,
                                          textAlign: TextAlign.start,
                                          style: TextStyle(fontSize: 12,
                                              color: Colors.white70,
  ...
  // );
  {
    final suggestions = query.isEmpty
        ? recentdrugs_phramGroup
        : drugstosearch_phramGroup.where((drugtosearch_phramGroup) {
      final drugtosearch_phramGroupLower = drugtosearch_phramGroup.toLowerCase();
      final queryLower = query.toLowerCase();

      return drugtosearch_phramGroupLower.startsWith(queryLower);
    }).toList();
