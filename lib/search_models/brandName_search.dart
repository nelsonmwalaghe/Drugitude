...
class SearchDrug_BrandName extends SearchDelegate {
  final FetchDrug_brandName _drugList_brandName = FetchDrug_brandName();
  final drugstosearch_brandName = [
                                    ...
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Padding(
                                          ...
                                          child: Text('Category: ${data_brandName?[index].category.name}',style: TextStyle(color: Colors.white54, fontSize: 12),),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                          child: Text('${data_brandName?[index].medicineName}',
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                          child: Text('${data_brandName?[index].innName}',
                                            textAlign: TextAlign.start,
                                            style: TextStyle(
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                          child: Text('Active Substance: ${data_brandName?[index].activeSubstance}',
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                          child: Text('${data_brandName?[index].therapeuticArea}',
                                            textAlign: TextAlign.start,
                                            style: TextStyle(
                                                color: Colors.white,
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                          child: Text('${data_brandName?[index].humanPharmacotherapeuticGroup}',
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                          child: Text('${data_brandName?[index].marketingAuthorisationHolderorCompanyName}',
                                              style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)
                                          ),
                                        ),
                                        Padding(
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                          child: Text('${data_brandName?[index].authorisationStatus.name}',
                                        ...
                                        Padding(
                                          ...
                                          child: Text('${data_brandName?[index].conditionOrIndication}',
                                            overflow: TextOverflow.fade,
                                            textAlign: TextAlign.start,
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.only(top: 0.0, bottom: 0, left: 8, right: 8),
                                          child: Text('Product Number: ${data_brandName?[index].productNumber}; ATC-Code: ${data_brandName?[index].atccode}, Generic? ${data_brandName?[index].generic.name}, Biosimilar? ${data_brandName?[index].biosimilar.name}, Conditional Approval: ${data_brandName?[index].conditionalApproval.name}, Exceptional Circumstances: ${data_brandName?[index].exceptionalCircumstances.name}, Accelerated Assessment: ${data_brandName?[index].acceleratedAssessment.name}, Orphan Medicine: ${data_brandName?[index].orphanMedicine.name}, Marketing Authorization Date: ${data_brandName?[index].marketingAuthorisationDate}, Date of Opinion: ${data_brandName?[index].dateofOpinion}, Decision Date: ${data_brandName?[index].decisionDate}, First Published: ${data_brandName?[index].firstPublished}, Revision Date: ${data_brandName?[index].revisionDate}, Revision Number: ${data_brandName?[index].revisionNumber}, url: ${data_brandName?[index].url}',
                                              overflow: TextOverflow.fade,
                                              textAlign: TextAlign.start,
                                              style: TextStyle(fontSize: 12,
                                                  color: Colors.white70,
  ...
  // );
  {
    final suggestions = query.isEmpty
        ? recentdrugs_brandName
        : drugstosearch_brandName.where((drugtosearch_brandName) {
      final drugtosearch_brandNameLower = drugtosearch_brandName.toLowerCase();
      final queryLower = query.toLowerCase();

      return drugtosearch_brandNameLower.startsWith(queryLower);
    }).toList();
