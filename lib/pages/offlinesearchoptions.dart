...
class OfflineSearchOptions extends StatefulWidget {
  const OfflineSearchOptions({super.key});

  @override
  State<OfflineSearchOptions> createState() => _OfflineSearchOptionsState();
}

class _OfflineSearchOptionsState extends State<OfflineSearchOptions> {
