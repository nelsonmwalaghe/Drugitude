...
class _AdrsReportFormWidgetState extends State<AdrsReportFormWidget> {
  ...
  //   return <Step> [
  //     Step(isActive: true,
  //         title: Text('ADRS REPORT',style: TextStyle(color: Colors.white)), subtitle: Text('INTRODUCTION',style: TextStyle(color: Colors.white)),
  //         content: Column(
  //           children: [
  //             Text('This report consists of FIVE Sections. Please tap to open and fill all the sections below.', style: TextStyle(color: Colors.white)),
  //             // ElevatedButton(
  ...
  //         )),
  //     Step(isActive: true,
  //         title: const Text('SECTION A', style: TextStyle(color: Colors.white)), subtitle: const Text('Preliminary info and Bio-Data', style: TextStyle(color: Colors.white)),
  //         content: Column(
  //           children: [
  ...
  //     ),
  //     Step(isActive: true,
  //         title: Text('SECTION B', style: TextStyle(color: Colors.white),),subtitle: const Text('CURRENT MEDICATION',style: TextStyle(color: Colors.white)),
  //         content: Text("List all medicines being currently used by the patient including OTC and herbal products.", style: TextStyle(color: Colors.white),)),
  //     Step(isActive: true,
  //         title: Text("CURRENT MEDICINE 1",
  ...
  //           ],
  //         ),),
  //     Step(title: Text("CURRENT MEDICINE 5",
  //       style: TextStyle(color: Colors.white,fontSize: 16),),
  //         content: Column(
  //           children: [
  ...
  //         ),),
  //     Step(isActive: true,
  //         title: const Text('SECTION C', style: TextStyle(color: Colors.white),),subtitle: const Text("PAST MEDICATION HISTORY: List all medicines used in the last 3 months including OTC, herbals and if pregnant indicate medicines used in the 1st trimester", style: TextStyle(color: Colors.white),),
  //         content:
  //         Column(
  //           children: [
  //             const Padding(
  //               padding: EdgeInsets.all(8.0),
  //               child: Text("PAST MEDICINE 1",
  //                 style: TextStyle(color: Colors.white,fontSize: 16),),
  //             ),
  ...
  //     ),
  //     Step(isActive: true,
  //         title: const Text('SECTION D',style: TextStyle(color: Colors.white),), subtitle: const Text("INTERVENTION HISTORY: Description of treatments, procedures and other actions taken to prevent or treat the reaction or improve patient's health in any other way.", style: TextStyle(color: Colors.white),),
  //   content:
  //     Column(
  //       children: [
  ...
  //     ),
  //     Step(isActive: true,
  //         title: const Text('SECTION E', style: TextStyle(color: Colors.white),), subtitle: const Text('CREDENTIALS: Reporter Identification Data',style: TextStyle(color: Colors.white),),
  //         content: Column(
  //           children: [
